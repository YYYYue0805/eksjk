    ...
    <el-scrollbar class="scrollThy">
      <el-tabs :value="this.activeName">
        <el-tab-pane name="one">
          <span slot="label">患者信息</span>
          <p class="thyroid-title">一般信息：</p>
          <div class="div-box" :style="{pointerEvents}">
            <p class="thyroid-title">
              父亲身高：<input class="input-underLine" v-model="ruleForm.fHeight" @blur="validateFatherHeight" />cm，
              父亲体重：<input class="input-underLine" v-model="ruleForm.fWeight" />kg
            </p>
            <p class="thyroid-title">
              母亲身高：<input class="input-underLine" v-model="ruleForm.mHeight" @blur="validateMotherHeight"/>cm，
              母亲体重：<input class="input-underLine" v-model="ruleForm.mWeight"/>kg
              初潮年龄：<input class="input-underLine" v-model="ruleForm.firstAge"/>岁，
            </p>
            <p class="thyroid-title">
              兄弟姐妹：<el-select size="small" v-model="ruleForm.bro" :disabled="isStatic">
                <el-option label="无" value="1"></el-option>
                <el-option label="有" value="2"></el-option>
              </el-select>
            </p>

            <div v-if="this.ruleForm.bro === '2'">
            ...
            >
              <el-table-column label="性别" >
                <template slot-scope="scope">
                  <el-select v-model="scope.row.sex" size="small" :disabled="isStatic">
              ...
              <el-table-column label="年龄" >
                <template slot-scope="scope">
                  <input v-model="scope.row.age" style="width: 2vw" class="input-underLine"/>岁
                  <input v-model="scope.row.mon" style="width: 2vw" class="input-underLine"/>月
                </template>
              </el-table-column>
              <el-table-column label="身高" >
                <template slot-scope="scope">
                  <el-input v-model="scope.row.height" @blur="validateHeights(scope.row.age,scope.row.height)" size="small"/>
                </template>
              </el-table-column>
              ...
              <el-table-column label="有无性早熟" >
                <template slot-scope="scope">
                  <el-select v-model="scope.row.health" size="small" :disabled="isStatic">
                    <el-option value="1" label="无性早熟"></el-option>
                    <el-option value="2" label="性早熟"></el-option>
                  </el-select>
                </template>
              </el-table-column>
              <el-table-column label="操作" width="120">
                <template slot-scope="scope">
                  <el-button @click.native.prevent="delRow(scope.$index,familyData)" class="el-icon-minus" size="mini"></el-button>
                </template>
              </el-table-column>
            </el-table>
            </div>
            <p class="thyroid-title">
              既往史：<el-select size="small" v-model="ruleForm.isHis" :disabled="isStatic">
                <el-option label="健康" value="1"></el-option>
                <el-option label="异常" value="2"></el-option>
              </el-select>
            </p>
            <el-input v-if="ruleForm.isHis === '2'"
                v-model="ruleForm.oldHis"
                type="textarea"
                :autosize="{ minRows: 3}"
                resize="none"
                placeholder="请输入既往的疾病及治疗情况"
                style="width: 97%"
                maxlength="1500"
                show-word-limit
            ></el-input>
        ...
        <el-tab-pane name="two">
          ...
          <div class="div-box" :style="{pointerEvents}">
            ...
            <p class="thyroid-title">
              ...
              <el-select v-if="ruleForm.growRate === '2'" size="small" v-model="ruleForm.rate" :disabled="isStatic">
          ...
          <div class="div-box" :style="{pointerEvents}">
            <p class="thyroid-title">
              身高：<input class="input-underLine" v-model="ruleForm.height" @blur="validateHeightFun"/>cm，
              体重：<input class="input-underLine" v-model="ruleForm.weight"/>kg，
            </p>
          ...
          <div class="div-box" :style="{pointerEvents}">
            ...
            <div class="thyroid-lie">
              <p class="lie-first">SHBG：<input v-model="ruleForm.HSBG" class="input-underLine"/>nmol/L</p>
              <p class="lie-con">
                检查时间：
                  <el-date-picker
                          size="small"
                          v-model="ruleForm.HSBGTime"
                          type="date"
                          :clearable="false"
                          :picker-options="pickerOptions"
            ...
            <div class="thyroid-lie">
              <p style="width: 620px">
                ...
                <input v-if="ruleForm.thyroid === '2'" class="input-underLine" style="width: 50%"
                      v-model="ruleForm.thyroidDescribe"/>
              </p>
              <p class="lie-last">
                检查时间：
                <el-date-picker
            ...
            <p style="width: 620px">
              ...
              <input v-if="ruleForm.LAKLGE === '2'" class="input-underLine" style="width: 50%" v-model="ruleForm.laklgeDescribe"/>
            </p>
            <p class="lie-last">
            检查时间：
            <el-date-picker
          ...
          <div class="checkBox">
            ...
            <div v-for="(item,index) in ImageList" :key="index">
              ...
              <div style="width: 100%;display: flex" :class="'divBox'+index">
                <ImageUpload
                    ...
                    :fileName="url"
                    @update:fileName="v =>upBoneImage(v,item.imageUrl,item.title,iIndex,ImageList)"
                    :editable="!isStatic"
                    :imageNum="iIndex"
                >
                </ImageUpload>
            ...
            <p class="thyroid-title" v-if="sex === '2'" :style="{pointerEvents}">
            ...
            <p v-if="sex === '1'" :style="{pointerEvents}">
              睾丸大小：
              右侧<input v-model="ruleForm.testisLeftOne" class="input-underLine"/>cm×
              <input v-model="ruleForm.testisLeftTwo" class="input-underLine"/>cm×
              <input v-model="ruleForm.testisLeftThr" class="input-underLine"/>cm ，
              长径<input v-model="ruleForm.testisLeftLon" class="input-underLine"/>cm；
              左侧<input v-model="ruleForm.testisRightOne" class="input-underLine"/>cm×
              <input v-model="ruleForm.testisRightTwo" class="input-underLine"/>cm×
              <input v-model="ruleForm.testisRightThr" class="input-underLine"/>cm ，
              长径<input v-model="ruleForm.testisRightLon" class="input-underLine"/>cm
            </p>
            检查时间：
            <el-date-picker
                    size="small"
                    v-model="ruleForm.gonadTime"
                    type="date"
                    :clearable="false"
                    :picker-options="pickerOptions"
            ...
            <p class="thyroid-title" :style="{pointerEvents}">
              ...
              <input v-if="ruleForm.MRI === '2'" class="input-underLine" style="width: 50%" v-model="ruleForm.mriDescribe"/>
            </p>
            <p class="thyroid-title" :style="{pointerEvents}">
              LHRH激发试验：
              LH峰值：<input class="input-underLine" v-model="ruleForm.LHmax"/>mIU/ml
              FSH峰值：<input class="input-underLine" v-model="ruleForm.FSHmax" @change="getLFmax"/>mIU/ml
              LH峰值/FSH峰值：<input class="input-underLine" v-model="ruleForm.LFmax"/>
            </p>
            <div class="thyroid-title" :style="{pointerEvents}">
              诊疗方案：
              <el-select v-model="ruleForm.diaPlan" :disabled="isStatic">
                ...
                <el-option value="9" label="中医药治疗"></el-option>
              </el-select>
              ...
              <span v-if="ruleForm.diaPlan === '8' ">
                <el-select v-model="ruleForm.anstrozole">
                  <el-option value="1" label="阿那曲唑0.5/片"></el-option>
                  <el-option value="2" label="阿那曲唑1/片"></el-option>
                  <el-option value="3" label="阿那曲唑1.5/片"></el-option>
                  <el-option value="4" label="阿那曲唑2/片"></el-option>
            ...
            <p class="thyroid-title" :style="{pointerEvents}">
              左侧甲状腺b超：
              <el-radio class="elRadio" v-model="ruleForm.CThyroidLB" label="1">正常</el-radio>
              <el-radio class="elRadio" v-model="ruleForm.CThyroidLB" label="2">异常</el-radio>
              <span v-if="ruleForm.CThyroidLB === '2'">甲状腺结节:&nbsp;&nbsp;&nbsp;分级:
                  <el-select class="m-2" allow-create filterable default-first-option size="small" placeholder="分级" v-model="ruleForm.CThyroidLBGradation" style='width:100px'>
                  ...
                  大小: <input class="input-underLine" v-model="ruleForm.CThyroidLBSize" style='width:100px'/>
                  弥漫性病变: <input class="input-underLine"  v-model="ruleForm.CThyroidLBLesions" style='width:100px'/>
                  其他:<input class="input-underLine"  v-model="ruleForm.CThyroidLBOther" style='width:100px'/>
            </span>
            </p>
            <p class="thyroid-title" :style="{pointerEvents}">
              右侧甲状腺b超：
              <el-radio class="elRadio" v-model="ruleForm.CThyroidRB" label="1">正常</el-radio>
              <el-radio class="elRadio" v-model="ruleForm.CThyroidRB" label="2">异常</el-radio>
              <span v-if="ruleForm.CThyroidRB === '2'">甲状腺结节:&nbsp;&nbsp;&nbsp;分级:
                  <el-select class="m-2" allow-create filterable default-first-option size="small" placeholder="分级" v-model="ruleForm.CThyroidRBGradation" style='width:100px'>
                    <el-option label="一级" value="一级"></el-option>
                    <el-option label="二级" value="二级"></el-option>
                    <el-option label="三级" value="三级"></el-option>
                    <el-option label="四级" value="四级"></el-option>
                  ...
                  大小: <input class="input-underLine" v-model="ruleForm.CThyroidRBSize" style='width:100px'/>
                  弥漫性病变: <input class="input-underLine"  v-model="ruleForm.CThyroidRBLesions" style='width:100px'/>
                  其他:<input class="input-underLine"  v-model="ruleForm.CThyroidRBOther" style='width:100px'/>
            </span>
            </p>
            检查时间：
              <el-date-picker
...
<!--              <el-select size="small" v-model="ruleForm.bioBank" :disabled="isStatic">-->
<!--                <el-option label="有" value="2"></el-option>-->
<!--                <el-option label="无" value="1"></el-option>-->
<!--              </el-select>-->
<!--              <span class="thyroid-title" v-show="this.ruleForm.bioBank === '2'">-->
<!--                样本编号：<input v-model="ruleForm.sampleId" class="input-underLine"/>-->
<!--                样本类型：-->
<!--                <el-select size="small" v-model="ruleForm.sampleClass" :disabled="isStatic">-->
<!--                  <el-option label="DNA样本" value="1"></el-option>-->
<!--                  <el-option label="血清" value="2"></el-option>-->
<!--                  <el-option label="血浆" value="3"></el-option>-->
<!--                  <el-option label="尿液" value="4"></el-option>-->
<!--                </el-select>-->
<!--              </span>-->
<!--            </div>-->
          </div>
        ...
        <el-tab-pane name="three">
          ...
          <div style="display: flex;width: 100%;margin-bottom: 1vw">
            <p class="thyroid-title" style="margin: 0px">生物样本库：</p>
            <el-select size="small" v-model="ruleForm.bioBank" :disabled="isStatic">
              <el-option label="有" value="2"></el-option>
              <el-option label="无" value="1"></el-option>
          ...
          <div style="display: flex;width: 100%;margin-top: 2vh;margin-bottom: 2vh" :style="{pointerEvents}">
        ...
        <el-tab-pane name="four" :style="{pointerEvents}" >
          ...
          <div class="div-box">
            ...
            <el-input v-if="ruleForm.mainDia=='周围性性早熟,其他(手填或不填)'"  placeholder="其他(手填或不填)" v-model="ruleForm.peripheralityOther"></el-input>
            <el-input v-if="ruleForm.mainDia=='部分性性早熟,其他(手填或不填)'"  placeholder="其他(手填或不填)" v-model="ruleForm.partialityOther"></el-input>
...
<script>
  ...
  export default {
    ...
    data() {
      return {
        options: [{
          ...
          label: '周围性性早熟',
          children: [{
            value: 'McCune-Albright综合征',
            label: 'McCune-Albright综合征'
          }, {
            value: '单纯性卵巢囊肿',
            label: '单纯性卵巢囊肿'
          }, {
        ...
        familyData: [{sex: '', age: '', mon: '', height: '', weight: '', health: ''}],
        genData: [{genName: '', Rna: '',mutationType:'',other:'', infestansLevel:'', amino: '', father: '', mother: '',},],
        sampleBank: [{id: '', name: ''},],
        ruleForm: {
          fHeight: '',
          fWeight: '',
          ...
          diaPlan: '',
          CThyroidLB:'',//甲状腺B超左
          CThyroidLBGradation:'',//甲状腺B超左(分级)
          CThyroidLBSize:'',//甲状腺B超左(大小)
          CThyroidLBLesions:'',//甲状腺B超左(弥漫性病变)
          CThyroidLBOther:'',////甲状腺B超左(其他)
          CThyroidRB:'',//甲状腺B超右
          CThyroidRBGradation:'',//甲状腺B超右(分级)
          CThyroidRBSize:'',//甲状腺B超右(大小)
          CThyroidRBLesions:'',//甲状腺B超右(弥漫性病变)
          CThyroidRBOther:'',////甲状腺B超右(其他)
          // GnRHa: '',
          rhGH: '',
          rhGHdose: '',
          // rhGHdoseKG:"",//自动计算数值
          ...
          sampleClass: [],
          mainDia: [],
          peripheralityOther:'',//周围性性早熟,其他
          partialityOther:'',//部分性性早熟,其他
          secDia: '',
          speKar: '',
          SRY: '',
          mutKind: '',
    ...
    methods: {
      ...
      addRow(tableData) {
        tableData.push({sex: '', age: '', mon: '', height: '', weight: '', health: ''})
      },
      delRow(index, rows) {
        rows.splice(index, 1);
      },
      ...
      getLFmax(){
        if(this.ruleForm.LHmax && this.ruleForm.FSHmax){
          this.ruleForm.LFmax = (this.ruleForm.LHmax/this.ruleForm.FSHmax).toFixed(2)
        }else {
          this.ruleForm.LFmax = "";
        }
      },
      addData() {
        this.ruleForm.familyData = this.familyData;
      ...
      getCase(){
        ...
        request.getCase({queryId}, data => {
          ...
          let temFam = data.fam_his ? JSON.parse(data.fam_his) : {};
          this.ruleForm.fHeight = temFam['fHeight'];
          this.ruleForm.fWeight = temFam['fWeight'];
          this.ruleForm.mHeight = temFam['mHeight'];
          this.ruleForm.mWeight = temFam['mWeight'];
          this.ruleForm.firstAge = temFam['firstAge'];
          this.ruleForm.bro = temFam['bro'];
          this.familyData = temFam['familyData'];
          this.ruleForm.isHis = temFam['isHis'];
          this.ruleForm.oldHis = temFam['oldHis'];

          this.ruleForm.firVisTime = data.first_time;
          this.ruleForm.morbidAge = data.age_ons;
          this.ruleForm.chiefCom = data.chi_com;
          let temGrow = data.acc_growth ? JSON.parse(data.acc_growth) : {};
          this.ruleForm.growRate = temGrow['growRate'];
          this.ruleForm.rate = temGrow['rate'];
          let temBs = data.menarche ? JSON.parse(data.menarche) : {};
          ...
          this.ruleForm.breastDevRight = tgjc['breastDev'];
          ...
          this.ruleForm.HSBG = tempLab['HSBG'];
          ...
          this.ruleForm.CThyroidLB = xxbc['CThyroidLB'];
          this.ruleForm.CThyroidLBGradation = xxbc['CThyroidLBGradation'];
          this.ruleForm.CThyroidLBSize = xxbc['CThyroidLBSize'];
          this.ruleForm.CThyroidLBLesions = xxbc['CThyroidLBLesions'];
          this.ruleForm.CThyroidLBOther = xxbc['CThyroidLBOther'];
          this.ruleForm.CThyroidRB = xxbc['CThyroidRB'];
          this.ruleForm.CThyroidRBGradation = xxbc['CThyroidRBGradation'];
          this.ruleForm.CThyroidRBSize = xxbc['CThyroidRBSize'];
          this.ruleForm.CThyroidRBLesions = xxbc['CThyroidRBLesions'];
          this.ruleForm.CThyroidRBOther = xxbc['CThyroidRBOther'];


          this.ruleForm.LHmax = data['LHmax'];
          this.ruleForm.FSHmax = data['FSHmax'];
          this.ruleForm.LFmax = data['LFmax'];
          ...
          this.ruleForm.peripheralityOther=mainDias['peripheralityOther'];
          this.ruleForm.partialityOther=mainDias['partialityOther'];
          // console.log(this.ruleForm.mainDia);
      ...
      addFollow() {
        // let follow = this.$refs.shortFollow.ruleForm;
      ...
      validateFatherHeight() {
        validateHeight(19, this.ruleForm.fHeight, 'father')
      },
      //母亲身高提示
      validateMotherHeight(){
        validateHeight(19, this.ruleForm.mHeight, 'mother')
      },
