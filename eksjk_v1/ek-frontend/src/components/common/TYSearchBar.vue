<template>
    <div class="search-bar">
      <div class="first">
        ...
        <el-input style="width: 100px" size="small" clearable v-model="filters.num"></el-input>
  
        <span class="title">性别：</span>
        <el-select v-model="filters.sex" size="small" clearable style="width: 100px">
        ...
        <el-input style="width: 100px" size="small" clearable v-model="filters.sclass"></el-input>
