<template>
      ...
      <el-scrollbar class="scrollThy">
        <el-tabs :value="this.activeName">
          <el-tab-pane name="one" :style="{pointerEvents}">
            ...
            <p class="thyroid-title">出生史：</p>
            <div class="div-box">
              <p class="thyroid-title" >母亲孕期疾病</p>
              <el-select size="small" v-model="ruleForm.isPregnancySickness" :disabled="isStatic">
                <el-option label="GBS" value="0"></el-option>
                <el-option label="GDM" value="1"></el-option>
                <el-option label="急性感染" value="2"></el-option>
                <el-option label="其他重大疾病" value="3"></el-option>
              </el-select>
              <span v-if="ruleForm.isPregnancySickness === '3'" :style="{pointerEvents}">
              描述：<input v-model="ruleForm.PregnancySickness" class="input-underLine" style="width: 40%"/>
            </span>

            <p class="thyroid-title" >是否多胎:</p>
            <el-select size="small" v-model="ruleForm.isMultiplePregnancies" :disabled="isStatic">
                <el-option label="否" value="0"></el-option>
                <el-option label="是" value="1"></el-option>
            </el-select>
              <span v-if="ruleForm.isMultiplePregnancies === '1'" :style="{pointerEvents}">
              几胎：<input v-model="ruleForm.MultiplePregnancies" class="input-underLine" style="width: 40%"/>
            </span>
            <p class="thyroid-title" >胎产次:</p>
            <el-select size="small" v-model="ruleForm.isParityG" :disabled="isStatic" placeholder="G">
            ...
            <el-select size="small" v-model="ruleForm.isParityP" :disabled="isStatic" placeholder="P">
            ...
            <div class="div-box">
              <p class="thyroid-title">
                身高：<input class="input-underLine" v-model="ruleForm.height" @blur="validateFinalHeight"/>cm，
              ...
              <div class="thyroid-title" :style="{pointerEvents}">
                ...
                <span v-if="ruleForm.diaPlan === '7'">
                  <el-select v-model="ruleForm.rhGH" allow-create filterable default-first-option clearable
                    ...
                    <el-option value="4" label="抑那通针11.25mg，每3月1次"></el-option>
            ...
            <div class="div-box" :style="{pointerEvents}">
              ...
              <div class="thyroid-lie">
                ...
                <p class="lie-con"  v-if="ruleForm.blood === '2'" >
                  <input class="input-underLine" style="width: 50%" v-model="ruleForm.bloodDescribe"/>
                </p>
                <p class="lie-last">
                  检查时间：
                  <el-date-picker
              ...
              <div class="thyroid-lie">
                ...
                <p class="lie-con" v-if="ruleForm.LAKLGE === '2'">
                  <input class="input-underLine" style="width: 50%" v-model="ruleForm.laklgeDescribe"/>
                </p>
                <p class="lie-last">
                  检查时间：
                  <el-date-picker
  ...
  <!--                     v-model="ruleForm.HBsDescribe"/>-->
            ...
            <div class="thyroid-lie">
              <p style="width: 620px">糖化血红蛋白A1c:<input v-model="followForm.glyHemA" class="input-underLine" />%</p>
              <p class="lie-last">
                检查时间：
                <el-date-picker
                      size="small"
      ...
      data() {
        return {
          ...
          ruleForm: {
            ...
            conHis: '1',
            pastOther: '',
            isPregnancySickness:'',//母亲孕期疾病
            PregnancySickness:'',//母亲孕期疾病其他重大疾病说明
            isMultiplePregnancies:'',//是否多胎
            MultiplePregnancies:'',//多胎说明
            isParityG:'',//胎产次 G:
            isParityP:'',//胎产次 P:
            firVisTime: '',
            morbidAge: '',
      ...
      methods: {
        ...
        getCase() {
          ...
          request.getCase({queryId}, data => {
            ...
            this.ruleForm.isPregnancySickness=data.mot_pre_dis;//母亲孕期疾病
            this.ruleForm.PregnancySickness=data.mot_pre_dis_ms;//母亲孕期疾病其他重大疾病说明
            this.ruleForm.isMultiplePregnancies=data.is_mul_bir;//是否多胎
            this.ruleForm.MultiplePregnancies=data.mul_bir_ms;//多胎说明
            this.ruleForm.isParityG=data.parity;//胎次
            this.ruleForm.isParityP=data.pronum;//产次
            ...
            this.ruleForm.fasBloodGluTime = tempLab['fasBloodGluTime'] || '';
            this.ruleForm.fasInsulin = tempLab['fasInsulin'] || '';
            this.ruleForm.fasInsulinTime = tempLab['fasInsulinTime'] || '';
            this.ruleForm.glyHem = tempLab['glyHem'] || '';
            this.ruleForm.glyHemTime = tempLab['glyHemTime'] || '';
