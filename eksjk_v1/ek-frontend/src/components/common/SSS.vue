        ...
        <el-tabs :value="this.activeName">
          <el-tab-pane name="one" :style="{pointerEvents}">
            ...
            <div class="div-box">
              ...
              <p class="thyroid-title">
              下部量：<input class="input-underLine" v-model="ruleForm.lowerMeasure"/>cm
              </p>
            ...
            <div class="div-box" >
              ...
              >
                ...
                <el-table-column label="健康调查" min-width="110">
                  <template slot-scope="scope">
                    <select v-model="scope.row.health">
                      <option value="1">健康</option>
                      <option value="2">基础疾病</option>
                    </select>
                    <p v-if="scope.row.health === '2'">
                      疾病名称： <input v-model="scope.row.disName" style="width: 90px" class="input-underLine"/>
                           </p>
                  </template>
                </el-table-column>
                <el-table-column label="臂长" width="110">
                <template slot-scope="scope">
                  <input v-model="scope.row.armLength" class="input-underLine"/>
                </template>
              </el-table-column>
              <el-table-column label="下部量" width="110">
                <template slot-scope="scope">
                  <input v-model="scope.row.lowerMeasure" class="input-underLine"/>
                </template>
              </el-table-column>
              <el-table-column label="病历号" width="110">
                <template slot-scope="scope">
                  <input v-model="scope.row.userNum" class="input-underLine"/>
                </template>
              </el-table-column>
    ...
    export default {
      ...
      data() {
        return {
          ...
          familyData: [{relation: '父亲', tAge:'', height: '', weight: '', age: '', health: '', disName: '',armLength:'',lowerMeasure:'',userNum:''},
            {relation: '母亲', tAge:'', height: '', weight: '', age: '', health: '', disName: '',armLength:'',lowerMeasure:'',userNum:''},
            {relation: '爷爷', tAge:'', height: '', weight: '', age: '', health: '', disName: '',armLength:'',lowerMeasure:'',userNum:''},
            {relation: '奶奶', tAge:'', height: '', weight: '', age: '', health: '', disName: '',armLength:'',lowerMeasure:'',userNum:''},
            {relation: '外公', tAge:'', height: '', weight: '', age: '', health: '', disName: '',armLength:'',lowerMeasure:'',userNum:''},
            {relation: '外婆', tAge:'', height: '', weight: '', age: '', health: '', disName: '',armLength:'',lowerMeasure:'',userNum:''},
          ],
          sampleBank: [{id: '', name: ''},],
      ...
      methods: {
        ...
        getCase() {
          ...
          request.getCase({queryId}, data => {
            ...
            // console.log(this.genData,"this.genDatathis.genDatathis.genData");
            ...
            this.ruleForm.lowerMeasure = tgjc['lowerMeasure'];
